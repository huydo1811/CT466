        ...
        <div class="p-8">
          ...
          <form @submit.prevent="handleSubmit" class="space-y-5">
            ...
            <div class="flex items-start">
              ...
              <label for="agreeTerms" class="ml-2 text-sm text-gray-300" :class="{'text-red-400': errors.agreeTerms}">
                Tôi đồng ý với <a href="#" class="text-primary-400 hover:text-primary-300 hover:underline">Điều khoản sử dụng</a>
              </label>
            </div>
          ...
          <div class="mt-5">
            <button type="button" class="w-full flex items-center justify-center px-4 py-2.5 bg-white hover:bg-gray-50 border border-gray-200 rounded-xl text-gray-800 font-medium transition group">
              ...
              <span class="group-hover:translate-x-1 transition-transform">Tiếp tục với Google</span>
            </button>
          </div>
